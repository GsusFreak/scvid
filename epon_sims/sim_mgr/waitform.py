...
class Ui_WaitForm(object):
    def setupUi(self, WaitForm):
        ...
        self.waitProgressBar = QtGui.QProgressBar(WaitForm)
        self.waitProgressBar.setGeometry(QtCore.QRect(43, 50, 118, 23))
        self.waitProgressBar.setProperty("value", 24)
        self.waitProgressBar.setObjectName(_fromUtf8("waitProgressBar"))
