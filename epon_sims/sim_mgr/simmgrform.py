...
class Ui_SimMgr(object):
    def setupUi(self, SimMgr):
        ...
        self.simListBox_2 = QtGui.QListWidget(SimMgr)
        self.simListBox_2.setGeometry(QtCore.QRect(20, 70, 301, 311))
        self.simListBox_2.setObjectName(_fromUtf8("simListBox_2"))
        self.notStartedListBox_2 = QtGui.QListView(SimMgr)
        self.notStartedListBox_2.setGeometry(QtCore.QRect(359, 70, 321, 141))
        self.notStartedListBox_2.setObjectName(_fromUtf8("notStartedListBox_2"))
        self.startedListBox_2 = QtGui.QListView(SimMgr)
        self.startedListBox_2.setGeometry(QtCore.QRect(359, 239, 321, 141))
